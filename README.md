...
| 원칙 | 기준 |
| ---- | ---- |
| 보여주기 | 감정·상태를 행동·감각·대화로 드러낸다 |
| 리듬 | 긴장 장면 짧은 문장 / 여운 장면 긴 문장 |
| 감각 | 시각 외 청각·촉각·후각·미각 활용 |
| 구체성 | 추상 표현보다 구체적 디테일 |
| **간결성** | 없애도 흐름이 끊기지 않는 문장은 쓰지 않는다. 빼도 의미가 달라지지 않는 단어는 넣지 않는다 |
...
1. `/review` — 구조·완성도·문체·간결성 확인 (A/B/C 판정)
   - `.claude/styles/default.md`가 있으면 스타일 프로필과 자동 대조
   - 불필요한 문장·단어도 B 판정 대상
2. `/revise` — 검토 주석 처리 (B: 문장·문체·간결성 수정, C: 구조 재설계)
